...
SKYCAIRFULLVERSION=$(cat /etc/skycair-version)
SKYCAIRVERSION=${SKYCAIRFULLVERSION#*-}
SKYCAIRVERSION=${SKYCAIRVERSION%%-*} 
...
APPLICATIONURL="https://github.com/omegaanswers/skycair/releases/download/$SKYCAIRVERSION/$CURRENTPACKAGE-$SLACKWAREVERSION.zip"
